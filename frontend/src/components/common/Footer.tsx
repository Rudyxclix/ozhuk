...
export const Footer: React.FC = () => {
  return (
    <footer className="w-full bg-surface-container-low border-t border-surface-container-high mt-auto">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-margin md:px-margin-desktop py-space-lg flex flex-col md:flex-row justify-between items-start md:items-center gap-space-md">
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-margin md:px-margin-desktop py-space-sm border-t border-surface-container flex flex-col sm:flex-row justify-between items-center gap-space-xs text-on-surface-variant font-label-sm text-label-sm">
